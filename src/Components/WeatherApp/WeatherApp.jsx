...
const WeatherApp = () => {
    ...
    let api_key = "a32e187aacde7899ad4f163b49ec3331";
    // to update weather icons
    ...
    const search = async () => {
        ...
        const humidity = document.getElementsByClassName("humidity-level")
    ...
    <div className='container'>
      ...
      <div className="data-container">
        <div className="element">
            ...
            <div className="data">
                <div className="humidity-level">80%</div>
